...
`grafit_status`. Проект определяется по текущей папке клиента (или параметром `project`).
...
`grafit status [--graph N --all]` · `grafit list` · `grafit eval [--golden file]` · `grafit mcp`
